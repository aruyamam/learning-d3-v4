...
function easingChart(enabled) {
  ...
  const easings = ['easeLinear', 'easePolyIn(4)', 'easeQuadIn', 'easeCubicIn', 'easeSinIn', 'easeSinIn', 'easeExpIn', 'easeCircleIn', 'easeElasticIn(10, -5)', 'easeBackIn(0.5)', 'easeBounceIn', 'easeCubicIn', 'easeCubicOut', 'easeCubicInOut'];
